  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/appointments/doctor" element={<ProtectedRoute><DoctorAppointments /></ProtectedRoute>}/>

        <Route path="/doctor/profile" element={<ProtectedRoute><DoctorProfile /></ProtectedRoute>}/>
        <Route path="/doctor/create-profile" element={<ProtectedRoute><CreateDoctorProfile /></ProtectedRoute>}/>
        <Route path="/doctor/update-profile" element={<ProtectedRoute><UpdateDoctorProfile /></ProtectedRoute>}/>
        <Route path="/doctor/availability" element={<ProtectedRoute><Availability /></ProtectedRoute>}/>
